define([
    ...
    return declare(null, {
		...
		labels : [
					...
					"Facilitate Adaptation - Urgent",
					"Reduce Threats – 1st choice",
					"Reduce Threats/Resist",
					"Reduce Threats/Relocate", 
					"Reduce Threats/Relocate - Urgent",
					"Restore – 1st choice",
					"Restore - 2nd choice",
					"Restore – 3rd choice",
					"Restore/Transform",
					"Restore/Reduce Threat",
					"Reassess/Reduce Threat",
					"Reassess",
					"Reassess - Urgent"
				],
